...
-- Step 5: Drop location_groups table
DROP TABLE IF EXISTS location_groups CASCADE;

-- Step 6: Make company_id NOT NULL only if there are stores
DO $$
BEGIN
...
CREATE POLICY "Anyone can view WAND products" ON wand_products FOR SELECT TO authenticated, anon USING (true);
CREATE POLICY "Anyone can insert WAND products" ON wand_products FOR INSERT TO authenticated, anon WITH CHECK (true);
CREATE POLICY "Anyone can update WAND products" ON wand_products FOR UPDATE TO authenticated, anon USING (true) WITH CHECK (true);
CREATE POLICY "Anyone can delete WAND products" ON wand_products FOR DELETE TO authenticated, anon USING (true);
CREATE POLICY "Anyone can view WAND templates" ON wand_templates FOR SELECT TO authenticated, anon USING (true);
CREATE POLICY "Anyone can insert WAND templates" ON wand_templates FOR INSERT TO authenticated, anon WITH CHECK (true);
CREATE POLICY "Anyone can update WAND templates" ON wand_templates FOR UPDATE TO authenticated, anon USING (true) WITH CHECK (true);
CREATE POLICY "Anyone can delete WAND templates" ON wand_templates FOR DELETE TO authenticated, anon USING (true);
CREATE POLICY "Anyone can view WAND attributes" ON wand_attributes FOR SELECT TO authenticated, anon USING (true);
CREATE POLICY "Anyone can insert WAND attributes" ON wand_attributes FOR INSERT TO authenticated, anon WITH CHECK (true);
CREATE POLICY "Anyone can update WAND attributes" ON wand_attributes FOR UPDATE TO authenticated, anon USING (true) WITH CHECK (true);
CREATE POLICY "Anyone can delete WAND attributes" ON wand_attributes FOR DELETE TO authenticated, anon USING (true);
CREATE POLICY "Anyone can view WAND integration sources" ON wand_integration_sources FOR SELECT TO authenticated, anon USING (true);
CREATE POLICY "Anyone can insert WAND integration sources" ON wand_integration_sources FOR INSERT TO authenticated, anon WITH CHECK (true);
CREATE POLICY "Anyone can update WAND integration sources" ON wand_integration_sources FOR UPDATE TO authenticated, anon USING (true) WITH CHECK (true);
CREATE POLICY "Anyone can delete WAND integration sources" ON wand_integration_sources FOR DELETE TO authenticated, anon USING (true);
CREATE POLICY "Anyone can view product assignments" ON product_assignments FOR SELECT TO authenticated, anon USING (true);
CREATE POLICY "Anyone can insert product assignments" ON product_assignments FOR INSERT TO authenticated, anon WITH CHECK (true);
CREATE POLICY "Anyone can update product assignments" ON product_assignments FOR UPDATE TO authenticated, anon USING (true) WITH CHECK (true);
CREATE POLICY "Anyone can delete product assignments" ON product_assignments FOR DELETE TO authenticated, anon USING (true);
CREATE POLICY "Anyone can view template assignments" ON template_assignments FOR SELECT TO authenticated, anon USING (true);
CREATE POLICY "Anyone can insert template assignments" ON template_assignments FOR INSERT TO authenticated, anon WITH CHECK (true);
CREATE POLICY "Anyone can update template assignments" ON template_assignments FOR UPDATE TO authenticated, anon USING (true) WITH CHECK (true);
CREATE POLICY "Anyone can delete template assignments" ON template_assignments FOR DELETE TO authenticated, anon USING (true);