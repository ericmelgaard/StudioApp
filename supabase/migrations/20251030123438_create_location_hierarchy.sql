...
CREATE POLICY "Anyone can insert concepts"
  ON concepts FOR INSERT
  TO authenticated, anon
  WITH CHECK (true);

CREATE POLICY "Anyone can update concepts"
...
CREATE POLICY "Anyone can insert location groups"
  ON location_groups FOR INSERT
  TO authenticated, anon
  WITH CHECK (true);

CREATE POLICY "Anyone can update location groups"
