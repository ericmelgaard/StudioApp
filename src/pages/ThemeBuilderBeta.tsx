...
export default function ThemeBuilderBeta({ themeId, themeName, onBack }: ThemeBuilderBetaProps) {
  ...
  return (
    <div className="h-[calc(100vh-4rem)] flex flex-col bg-slate-50 text-slate-900">
      {/* Fixed Action Bar */}
      <div className="flex-shrink-0 bg-white border-b border-slate-200">
        {/* Top Row: Back, Theme Name, Display Type */}
      ...
      {/* Scrollable Three-Column Workspace */}
