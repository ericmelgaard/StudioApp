  ...
  return (
    <div className="relative">
      ...
      <button
        ...
        disabled={disabled}
        className={`w-full px-3 py-2.5 border border-slate-300 dark:border-slate-600 rounded-lg font-mono text-base text-left transition-colors ${
          disabled
            ? 'bg-slate-100 dark:bg-slate-800 text-slate-400 dark:text-slate-600 cursor-not-allowed'
            : 'bg-white dark:bg-slate-900 text-slate-900 dark:text-slate-100 hover:bg-slate-50 dark:hover:bg-slate-800 focus:ring-2 focus:ring-slate-400 focus:border-transparent'
        }`}
      >
