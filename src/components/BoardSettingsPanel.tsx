...
export function BoardSettingsPanel({
  ...
  if (!selectedPlaylistAsset || !selectedAsset) {
    return (
      <div className="bg-white border-l border-slate-200 flex items-center justify-center p-6">
        <div className="text-center">
          <div className="w-16 h-16 bg-slate-100 rounded-full flex items-center justify-center mx-auto mb-4">
            <Settings className="w-8 h-8 text-slate-400" />
          </div>
          <h3 className="text-lg font-medium text-slate-700 mb-2">No Asset Selected</h3>
  ...
  return (
    <div className="bg-white border-l border-slate-200 overflow-y-auto">
      ...
      <div className="p-4 space-y-6">
        <div>
          <h3 className="text-sm font-medium text-slate-700 mb-3">Asset Info</h3>
          <div className="space-y-2">
            <div>
              <div className="text-xs text-slate-500 mb-1">Title</div>
              <div className="text-sm text-slate-900">{selectedAsset.title}</div>
            </div>
            <div>
            ...
            {selectedAsset.description && (
              <div>
                ...
                <div className="text-sm text-slate-900">{selectedAsset.description}</div>
              </div>
            )}
          </div>
        </div>
        ...
        <div className="border-t border-slate-200 pt-6">
          <div className="p-3 bg-slate-50 rounded-lg border border-slate-200">
            <h4 className="text-xs font-medium text-slate-700 mb-2">Quick Info</h4>
