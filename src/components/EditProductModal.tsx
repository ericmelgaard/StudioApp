                                    ...
                                    <div className="absolute right-0 mt-1 w-56 bg-white border border-slate-200 rounded-lg shadow-lg z-10 overflow-hidden">
                                      {!isOverridden && (
                                        <button
                                          ...
                                          className="w-full px-3 py-2.5 text-left text-sm hover:bg-slate-50 flex items-start gap-2 border-b border-slate-100"
                                        >
                                          <Unlink className="w-4 h-4 text-amber-600 mt-0.5 flex-shrink-0" />
                                          <div>
                                            <div className="font-medium text-slate-900">Apply Locally</div>
                                            <div className="text-xs text-slate-500 mt-0.5">Override and stop syncing</div>
                                          </div>
                                        </button>
                                      )}
                                      {isOverridden && (
                                        ...
                                        >
                                          ...
                                          <div>
                                            ...
                                            <div className="text-xs text-slate-500 mt-0.5">Use value: <span className="font-mono">{typeof integrationValue === 'object' ? JSON.stringify(integrationValue) : integrationValue}</span></div>
                                          </div>
                                        </button>
                                      )}
                                    </div>
