...
export default function FieldLinkModal({
  ...
  return (
    <div
      className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-[350] p-4"
      onClick={handleClose}
    >
      <div
        className="relative z-[351] bg-white rounded-xl shadow-2xl w-full max-w-3xl h-[90vh] flex flex-col"
