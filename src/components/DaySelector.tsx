      ...
      {showPresets && (
        <div className="flex flex-wrap gap-2 mb-3">
          <button
            ...
            className="px-3 py-1.5 bg-white dark:bg-slate-800 text-slate-700 dark:text-slate-300 border border-slate-300 dark:border-slate-600 rounded-lg text-xs font-medium hover:bg-slate-50 dark:hover:bg-slate-700 transition-colors"
          >
            Weekdays
          </button>
          <button
